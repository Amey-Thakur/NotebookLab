<!--
  Name: README.md
  Purpose: The press kit: the booklet and the reference cards, free to reuse.
...
The booklet and the reference cards, free to use anywhere, with attribution appreciated but not required. Everything is MIT licensed like the rest of the project.
